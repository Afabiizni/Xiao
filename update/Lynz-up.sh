...
sleep 2
wget -q -O /usr/bin/menu "https://raw.githubusercontent.com/Afabiizni/xiao/main/menu/menu.sh" && chmod +x /usr/bin/menu
wget -q -O /usr/bin/menu-ssh "https://raw.githubusercontent.com/Afabiizni/xiao/main/menu/menu-ssh.sh" && chmod +x /usr/bin/menu-ssh
